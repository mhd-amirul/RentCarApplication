        ...
        <div class="card px-4 py-4 border border-grey-500">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    {{-- <a href="{{ route('activityAdd',$shop->slug) }}" class="mt-1 btn btn-primary"><i class="bi bi-file-earmark-plus"></i> Tambah</a>
                    <a href="{{ route('activityHistory',$shop->slug) }}" class="mt-1 btn btn-secondary"><i class="bi bi-clock-history"></i>  History</a>
