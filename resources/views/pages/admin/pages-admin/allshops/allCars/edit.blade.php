        ...
        <main class="form-registration mt-3">
            ...
            <form action="{{ route('updateCarAdmin', $car->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-floating">
                    <input type="stok" name="stok" class="form-control rounded-top @error('stok') is-invalid @enderror" id="stok" placeholder="Stok" value="{{ old('stok', $car->stok) }}" required>
                    ...
                    <div class="row px-2">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-10 mt-4">
                                <button class="w-100 btn btn-danger mt-3" type="submit">EDIT MOBIL</button>
                            </div>
                        </div>
                    </div>
                </form>
